...
function createVirtualTables {
  ...
  createTable "virtual_mailbox" "CREATE TABLE IF NOT EXISTS virtual_mailboxes (id SERIAL PRIMARY KEY, username VARCHAR(255) NOT NULL UNIQUE, maildir VARCHAR(255) NOT NULL);"
...
function insertInitialData {
  ...
  local insert_sql="
    ...
    INSERT INTO virtual_mailbox (username, maildir) VALUES ('info@mail.smartquail.io', '/var/mail/info') ON CONFLICT DO NOTHING;
