...
echo "PGPASSWORD=${POSTFIX_POSTGRES_PASSWORD}"
echo "PGUSER=${POSTFIX_POSTGRES_USER}"
echo "POSTFIX_POSTGRES_DB=${POSTFIX_POSTGRES_DB}"
echo "POSTFIX_POSTGRES_USER=${POSTFIX_POSTGRES_USER}"
echo "POSTFIX_POSTGRES_HOST=${POSTFIX_POSTGRES_HOST}"
